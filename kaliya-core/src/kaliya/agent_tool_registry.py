...
TOOLS: dict[str, ToolDefinition] = {
    ...
    "youtube_search_trends": ToolDefinition(
        "youtube_search_trends",
        "Research YouTube trends",
        "youtube_growth",
        "read",
        "Research timely topics, rising channels, regional trends, and content gaps through permitted YouTube API data with source URLs.",
        connected_apps=("youtube",),
    ),
    "youtube_analyze_competitors": ToolDefinition(
        "youtube_analyze_competitors",
        "Analyze YouTube competitors",
        "youtube_growth",
        "read",
        "Compare observable channel and video metrics, breakout patterns, formats, hooks, and calls to action while separating facts from interpretation.",
        connected_apps=("youtube",),
    ),
    "youtube_analyze_video": ToolDefinition(
        "youtube_analyze_video",
        "Analyze YouTube video",
        "youtube_growth",
        "read",
        "Analyze metadata, available captions and timestamps, comments, and audience signals without claiming frame or edit analysis for public videos.",
        connected_apps=("youtube",),
    ),
    "youtube_create_content_plan": ToolDefinition(
        "youtube_create_content_plan",
        "Create YouTube content plan",
        "youtube_growth",
        "draft",
        "Create a schema-validated 7-day or 30-day content plan from source-backed research and channel context without view guarantees.",
        connected_apps=("youtube",),
    ),
    "youtube_create_creative_package": ToolDefinition(
        "youtube_create_creative_package",
        "Create YouTube creative package",
        "youtube_growth",
        "draft",
        "Draft titles, hooks, thumbnail briefs, script structure, CTA, chapters, Shorts ideas, and facts that require verification.",
        connected_apps=("youtube",),
    ),
    "youtube_analyze_growth": ToolDefinition(
        "youtube_analyze_growth",
        "Analyze YouTube growth",
        "youtube_growth",
        "read",
        "Compare available owner-channel performance with that channel's own baseline and return source-backed growth recommendations.",
        connected_apps=("youtube",),
    ),
...
AGENT_TOOL_PROFILES: dict[str, AgentToolProfile] = {
    ...
    "youtube-trend-scout": AgentToolProfile(
        "youtube-trend-scout",
        "Trend Scout. Performs source-backed, read-only YouTube trend and opportunity research.",
        ("youtube_search_trends",),
    ),
    "youtube-competitor-analyst": AgentToolProfile(
        "youtube-competitor-analyst",
        "Competitor Analyst. Compares observable competitor evidence and clearly labels interpretation.",
        ("youtube_analyze_competitors",),
    ),
    "youtube-video-analyst": AgentToolProfile(
        "youtube-video-analyst",
        "Video Analyst. Reviews metadata, available captions, comments, and limitations without claiming unsupported visual analysis.",
        ("youtube_analyze_video",),
    ),
    "youtube-content-strategist": AgentToolProfile(
        "youtube-content-strategist",
        "Content Strategist. Produces schema-validated, evidence-backed YouTube content plans.",
        ("youtube_create_content_plan",),
    ),
    "youtube-creative-director": AgentToolProfile(
        "youtube-creative-director",
        "Creative Director. Produces editable creative drafts and explicit fact-check requirements.",
        ("youtube_create_creative_package",),
    ),
    "youtube-growth-analyst": AgentToolProfile(
        "youtube-growth-analyst",
        "Growth Analyst. Reads owner-channel analytics and compares results with channel-specific baselines.",
        ("youtube_analyze_growth",),
    ),
    "youtube-publisher": AgentToolProfile(
        "youtube-publisher",
        "Publisher. Executes only a separately approved YouTube upload after presenting the final settings and media.",
        ("get_connected_apps_status", "upload_youtube_video"),
    ),
}
